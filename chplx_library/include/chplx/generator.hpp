...
//                     block std::size_t const count = (size +
...
//                     alloc.deallocate(static_cast<aligned_block*>(ptr),
//                     count);
//                 }
//                 else
//                 {
...
//                 char* address = static_cast<char*>(ptr) -
//                 sizeof(std::size_t); dealloc(address,
...
//                     std::memcpy(address + size + sizeof(std::size_t),
//                     &dealloc,
//                         sizeof(dealloc));
...
//                     // store deleter
//                     std::memcpy(address + sizeof(std::size_t) + size,
//                     &dealloc,
//                         sizeof(dealloc));
...
//                 // the size is stored before the address
//                 char* address = static_cast<char*>(ptr) -
//                 sizeof(std::size_t); std::size_t const size =
//                     *reinterpret_cast<std::size_t*>(address);
...
//                 // the size is stored before the address
//                 char* address = static_cast<char*>(ptr) -
//                 sizeof(std::size_t); HPX_ASSERT(size ==
//                 *reinterpret_cast<std::size_t*>(address));
...
//             {
//                 static_assert(std::same_as<gen_yield_t<gen_reference_t<Ref,
//                 V>>,
//                     Yielded>);
...
//                     gen_promise_base& parent_promise =
//                     nested.parent.promise(); if (parent_promise.info)
//                     {
...
//             merged. hpx::coroutine_handle<gen_promise_base> top =
