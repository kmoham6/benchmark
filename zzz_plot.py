...
# ax.set_title('SpeedUp for different Number of Cores vs "acc" executor')
ax.set_title('Compute bound Performance Across Various Core Counts vs "acc" Executor ')

# Add a legend to identify each benchmark
ax.legend(title='Benchmark', loc='best')

# Save the figure as a JPG file
plt.savefig('line_chart_multiple_cases_core_compute_new.jpg', format='jpg')
